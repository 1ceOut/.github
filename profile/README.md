  # 냉장고의 모든 비밀(${\textsf{\color{#83C9E7}냉모밀}}$) - ${\textsf{\color{#4A88DA}얼음땡}}$
...
<details>
<summary><a href="https://github.com/1ceOut/login_service">🔐 로그인</a></summary>

${\textsf{\color{#83C9E7}다양한 소셜 로그인을 기능을 제공함으로써 접근성을 향상시켜 유저 친화적으로 다른 기능을 원활하게 사용할 수 있습니다.}}$
...
<details>
<summary><a href="https://github.com/1ceOut/Refrigerator_management">🧊 냉장고 관리</a></summary>


${\textsf{\color{#83C9E7}냉장고 생성, 조회, 수정, 삭제 기능을 제공하여 냉장고를 갯수제한 없이 관리하는 부분을 편리하게 제공합니다.}}$

  - 냉장고 생성 : 냉장고를 생성할 경우 냉장고의 이름을 12글자 이내로 지정하여 생성합니다.
...
${\textsf{\color{#83C9E7}식재료 추가, 조회, 수정, 삭제 기능을 통해 사용자가 식재료를 좀 더 효율적으로 관리 할 수 있도록 합니다.}}$
...
${\textsf{\color{#83C9E7}여러 사용자가 냉장고를 함께 관리할 수 있는 공동 관리 기능을 제공합니다. 사용자는 냉장고를 다른 사람과 공유하고, 채팅 기능을 통해 냉장고 관리와 관련된 소통을 할 수 있습니다. 이를 통해 가정, 직장, 또는 공유 주방 등 다양한 상황에서 냉장고를 효율적으로 활용할 수 있습니다.}}$
...
#### 📋 커뮤니티
<details>
<summary><a href="https://github.com/1ceOut/community_board">📤레시피 공유 게시판</a></summary>
...
<details>
<summary><a href="https://github.com/1ceOut/likecomment">👍 좋아요 / 💬 댓글 / 🔔 구독</a></summary>

${\textsf{\color{#83C9E7}게시글 좋아요, 댓글 / 게시글 작성자 구독 기능을 통해 자신의 게시글 및 자신에 대한 다른 사용자들의 평가를 받아볼 수 있습니다.}}$
...
<br>
<details>
<summary><a href="https://github.com/1ceOut/broadcast">📺 실시간 방송</a></summary>

${\textsf{\color{#83C9E7}실시간 방송을 통해 실시간으로 자신의 요리 과정 및 다른 사용자들의 피드백을 제공받을 수 있습니다.}}$

  - 방송 시작 : 커뮤니티의 자신의 프로필 사진의 ➕ 버튼을 클릭하여 방송을 시작할 수 있습니다.
  - 화면, 음성, 화면 공유 : 자신이 방송 게시자 일 경우, 자신의 화면, 음성, 화면 공유 On/Off를 하단의 버튼을 통해 컨트롤할 수 있습니다.
